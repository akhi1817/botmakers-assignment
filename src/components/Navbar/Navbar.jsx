...
<div className="max-w-7xl mx-auto flex items-center justify-between px-6 h-20">
        ...
        {/* Logo */}
          <Link to="/"><img src={logo} alt="BotLeague Logo" className="h-12 w-auto object-contain"/></Link>
        ...
        {/* Buttons */}
            <div className="hidden md:flex gap-3">
              <button className="px-5 py-2 border border-gray-600 text-white rounded-md hover:bg-white hover:text-black transition">Login</button>
      
              <button className="px-5 py-2 bg-red-500 hover:bg-red-600 rounded-md text-white">Register Now</button>
            </div>
