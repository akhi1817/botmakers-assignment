...
const Hero = () => {
 ...
 <img
  src={heroBg}
  alt="Hero"
  className="absolute top-0 -right-48 h-full max-w-none object-cover"
/>
...
<div className="ml-4 mt-16">
  <h1 className="heading text-2xl md:text-6xl font-bold uppercase text-white leading-[1.05]">
    INDIA'S ULTIMATE
    <br />
    ROBOTICS ARENA
  </h1>
          ...
          {/* Description */}
          <p className="text-gray-300 ml-8 mt-6 text-lg max-w-xl">
